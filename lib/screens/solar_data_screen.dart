...
class SolarDataScreen extends StatelessWidget {
  const SolarDataScreen({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Pick the data type to generate your chart',
              style: Theme.of(context).textTheme.titleLarge?.copyWith(
                    color: const Color(0xFF4CAF50),
                  ),
            ),
            const SizedBox(height: 30),
            _DataTypeButton(
              title: 'Fetch Yearly Data',
              onTap: () {},
            ),
            const SizedBox(height: 15),
            _DataTypeButton(
              title: 'Fetch Daily Data',
              onTap: () {},
            ),
            const SizedBox(height: 15),
            _DataTypeButton(
              title: 'Fetch Minute Data',
              onTap: () {},
            ),
            const SizedBox(height: 15),
            _DataTypeButton(
              title: 'Fetch Monthly Data',
              onTap: () {},
            ),
          ],
        ),
