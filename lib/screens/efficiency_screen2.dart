        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.titleLarge?.copyWith(color: const Color(0xFF4CAF50)),
            ),
            ...
            const SizedBox(height: 20),
            const _DateRow(label: 'day:', date: 'Jun 10, 2024'),
  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: [
        ...
        Text(date, style: const TextStyle(color: Color(0xFF4CAF50))),
        Text(
          'start hour:',
          style: TextStyle(color: Colors.white.withOpacity(0.7)),
        ),
        Text(time, style: const TextStyle(color: Color(0xFF4CAF50))),
      ],
    );
  }
}
...
class _DataTypeButton extends StatefulWidget {
  ...
  const _DataTypeButton({required this.title, required this.onTap});
